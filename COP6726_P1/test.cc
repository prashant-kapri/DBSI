...
const char *dbfile_dir = "/cise/homes/kapri.prashant/temp/"; // dir where binary heap files should be stored
const char *tpch_dir ="/cise/homes/kapri.prashant/test/tpch-dbgen/"; // dir where dbgen tpch files (extension *.tbl) can be found
